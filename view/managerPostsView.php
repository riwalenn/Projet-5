                ...
                <div class="card" id="profil_Dash">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        <blockquote class="blockquote mb-0">
                            <footer class="blockquote-footer" style="color: #00c0c7"><i class="fa fa-file-alt"></i>
                                Posts Manager
                            </footer>
                        </blockquote>
                            ...
                            <form action="index.php?action=postsManager&value=<?= $value ?>&CRUD=U" method="post">
                                ...
                                <form action="index.php?action=postsManager&value=<?= $value ?>&CRUD=D" method="post">
                                    ...
                                    <tr>
                                        <td>
                                            <?php if ($post->getState() != 3): ?>
                                                <a data-toggle="modal" href="#formModalEdit<?= $post->getId() ?>"><i
                                        ...
                                        <td>
                                            <select name="state"
                                                    class="form-control form-control-sm <?= $post->getStateClass() ?>">
                                                <?php
                                        ...
                                        <?php else: ?>
                                            <td>
                                                <button class="btn btn-danger adm-users" type="submit">Supprimer
                                                    l'article
                                                </button>
                                            </td>
                                        <?php endif; ?>
...
<?php foreach ($postsList as $post) : ?>
    <div class="articles-modal modal fade" id="formModalEdit<?= $post->getId() ?>" tabindex="-1" role="dialog"
         aria-hidden="true">
                                ...
                                <form id="formDataUser" action="index.php?action=postsManager&value=all&CRUD=FU"
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="pseudo" class="form-control form-control-sm"
                                               placeholder="entrez le pseudo ici" name="pseudo"
                                               value="<?= $post->getPseudo() ?>"
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="author" class="form-control form-control-sm"
                                               name="author" value="<?= $post->getAuthor() ?>">
                                    </div>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1"><i
                                        ...
                                        <label for="content"></label><textarea class="form-control" id="kicker" rows="3"
                                                                               name="kicker"
                                                                               placeholder="entrez le contenu du châpo ici"
                                                                               required><?= $post->getKicker() ?></textarea>
                                    </div>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1"><i
                                        ...
                                        <label for="content"></label><textarea class="form-control summernote"
