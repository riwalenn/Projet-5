<div class="container views">
    <div class="row">
        <form action="index.php?action=modifierPassword" method="post" onsubmit="return verifFormPassword(this)" >
            ...
            <!--<div class="input-group mb-3">
                ...
                <input id="passwordBis" class="form-control form-control-sm classeMdp" placeholder="confirmez votre mot de passe" aria-label="password" type="password" name="passwordBis" maxlength="64" minlength="10" onblur="verifPasswordBis(this)" required>
            </div>-->
