                        ...
                        <div class="card-header">
                            <blockquote class="blockquote mb-0">
                                <footer class="blockquote-footer">Dernière connexion
                                    : <?= $user->getDate_modification() ?></footer>
                            </blockquote>
                        </div>
                                    ...
                                    <form action="index.php?action=deleteFavorite" method="post"
                                        ...
                                        <tr>
                                            <td><p class="favorites-posts-links"><a class="articles-link"
                                                                                    data-toggle="modal"
                                                                                    href="#articlesModal<?= $post->getId() ?>"><i
                                                                class="fas fa-star"
                                                                style="color: #fed136"></i> <?= $post->getTitle() ?></a>
                                                </p></td>
                                            <td>
                                                <button class="btn btn-link" aria-label="supprimer" type="submit"
                                                        value="deletion"><i class="far fa-trash-alt"
                    ...
                    <div class="card" id="profil_Dash">
                        ...
                        <div class="card-body articles-caption">
                            ...
                            <?php foreach ($lastPosts as $post) : ?>
                                <h5><b><a class="articles-link" data-toggle="modal"
                                          href="#articlesModal<?= $post->getId() ?>"><?= $post->getTitle() ?></a></b>
                                </h5>
                                ...
                                <form id="formDataUser" action="index.php?action=modifDataUser" method="post"
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="pseudo" class="form-control form-control-sm"
                                               ...
                                               onkeyup="verifPseudo(this)" value="<?= $user->getPseudo() ?>" required>
                            ...
                            <div class="col-lg-8 mx-auto">
                                <div class="modal-body">
                                    ...
                                    <cite title="Auteur" class="item-intro text-muted">Créé
                                        par <?= $post->getPseudo() ?> -
                                        le <?= $post->getCreated_at() ?> / Modifié
                                        le <?= $post->getModified_at() ?></cite>
                                                ...
                                                <form action="index.php?action=addComment" method="post">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input class="form-control form-control-sm"
                                                               ...
                                                               aria-label="commentaire" type="text" name="content"
                                                               required>
                                                    </div>
