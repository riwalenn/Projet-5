                ...
                <div class="card" id="profil_Dash">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        <blockquote class="blockquote mb-0">
                            <footer class="blockquote-footer" style="color: #00c0c7"><i class="fa fa-user"></i> Users
                                Manager
                            </footer>
                        </blockquote>
                            ...
                            <form action="index.php?action=usersManager&value=<?= $value ?>&CRUD=U" method="post">
                                ...
                                <form action="index.php?action=usersManager&value=<?= $value ?>&CRUD=D" method="post">
                                    ...
                                    <tr>
                                        <td>
                                            <?php if ($user->getState() != 3) : ?>
                                                <a data-toggle="modal" href="#formModalEdit<?= $user->getId() ?>"><i
                                        ...
                                        <td>
                                            <label>
                                                <select name="state"
                                                        class="form-control form-control-sm <?= $user->getStateClass() ?>">
                                                    <?php
                                        ...
                                        <?php else: ?>
                                            <td>
                                                <button class="btn btn-danger adm-users" type="submit">Supprimer le
                                                    compte
                                                </button>
                                            </td>
                                        <?php endif; ?>
...
<?php foreach ($usersList as $user) : ?>
    <!-- Modal edit user -->
    <div class="articles-modal modal fade" id="formModalEdit<?= $user->getId() ?>" tabindex="-1" role="dialog"
         aria-hidden="true">
                            ...
                            <div class="modal-body">
                                ...
                                <form id="formDataUser"
                                    ...
                                    <button class="btn btn-primary my-2 my-sm-0" aria-label="modifier" type="submit"
                                            value="edit">Modifier un utilisateur
                                    </button>
                                </form>
                            </div>
                        </div>
