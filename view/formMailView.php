<div class="container views">
    ...
    <div class='row helpmessage'>
        ...
        <div class='popover-body'>
            <p><i class="fas fa-info-circle pseudo"></i> Merci de renseigner votre adresse email, vous recevrez par la
                suite un email avec un lien qui vous permettra de changer votre mot de passe.</p>
        </div>
    </div>
</div>