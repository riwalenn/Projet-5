                        ...
                        <div class="modal-body">
                            ...
                            <p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans
                                l'économie numérique, il est précisé aux utilisateurs du site <a
                                        href="<?= Constantes::HTTPS_URL.Constantes::WWW_RIWALENN ?>"><?= Constantes::WWW_RIWALENN ?></a> l'identité des
                            ...
                            <p><strong>Propriétaire</strong> : Riwalenn Bas – 1 rue françois arago<br/>
                                <strong>Créateur</strong> : <a href="https://<?= Constantes::WWW_RIWALENN ?>">Riwalenn Bas</a><br/>
                            ...
                            <p>L’utilisation du site <a href="<?= Constantes::HTTPS_URL.Constantes::WWW_RIWALENN ?>"><?= Constantes::WWW_RIWALENN ?></a>
                                ...
                                à tout moment, les utilisateurs du site <a href="<?= Constantes::HTTPS_URL.Constantes::WWW_RIWALENN ?>"><?= Constantes::WWW_RIWALENN ?></a>
                            ...
                            <p>Ce site est normalement accessible à tout moment aux utilisateurs. Une interruption pour
                                ...
                                l’intervention.</p>
                            <p>Le site <a href="<?= Constantes::HTTPS_URL.Constantes::WWW_RIWALENN ?>"><?= Constantes::WWW_RIWALENN ?></a> est mis à jour
                            ...
                            <p>Le site <a href="<?= Constantes::HTTPS_URL.Constantes::WWW_RIWALENN ?>"><?= Constantes::WWW_RIWALENN ?></a> a pour objet de
                                fournir une information concernant l’ensemble des activités de la société.</p>
                            <p>Riwalenn Bas s’efforce de fournir sur le site <a href="<?= Constantes::HTTPS_URL.Constantes::WWW_RIWALENN ?>"><?= Constantes::WWW_RIWALENN ?></a>
                                ...
                                informations.</p>
                            <p>Tous les informations indiquées sur le site <a href="<?= Constantes::HTTPS_URL.Constantes::WWW_RIWALENN ?>"><?= Constantes::WWW_RIWALENN ?></a>
                                sont données à titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
                                renseignements figurant sur le site <a href="<?= Constantes::HTTPS_URL.Constantes::WWW_RIWALENN ?>"><?= Constantes::WWW_RIWALENN ?></a>
                            ...
                            <p>Riwalenn Bas ne pourra être tenue responsable des dommages directs et indirects causés au
                                matériel de l’utilisateur, lors de l’accès au site <?= Constantes::WWW_RIWALENN ?>, et résultant
                            ...
                            <p>Riwalenn Bas ne pourra également être tenue responsable des dommages indirects (tels par
                                ...
                                site <a href="<?= Constantes::HTTPS_URL.Constantes::WWW_RIWALENN ?>"><?= Constantes::WWW_RIWALENN ?></a>.</p>
                            ...
                            <p>A l'occasion de l'utilisation du site <a href="<?= Constantes::HTTPS_URL.Constantes::WWW_RIWALENN ?>"><?= Constantes::WWW_RIWALENN ?></a>,
                                peuvent êtres recueillies : l'URL des liens par l'intermédiaire desquels l'utilisateur a
                                accédé au site <a href="<?= Constantes::HTTPS_URL.Constantes::WWW_RIWALENN ?>"><?= Constantes::WWW_RIWALENN ?></a>, le
                            ...
                            <p> En tout état de cause Riwalenn Bas ne collecte des informations personnelles relatives à
                                l'utilisateur que pour le besoin de certains services proposés par le site <a
                                        href="<?= Constantes::HTTPS_URL.Constantes::WWW_RIWALENN ?>"><?= Constantes::WWW_RIWALENN ?></a>. L'utilisateur
                                ...
                                lui-même à leur saisie. Il est alors précisé à l'utilisateur du site <a
                                        href="<?= Constantes::HTTPS_URL.Constantes::WWW_RIWALENN ?>"><?= Constantes::WWW_RIWALENN ?></a> l’obligation ou non
                            ...
                            <p>Aucune information personnelle de l'utilisateur du site <a
                                    href="<?= Constantes::HTTPS_URL.Constantes::WWW_RIWALENN ?>"><?= Constantes::WWW_RIWALENN ?></a> n'est publiée à l'insu
                                de
                                ...
                                l'utilisateur du site <a href="<?= Constantes::HTTPS_URL.Constantes::WWW_RIWALENN ?>"><?= Constantes::WWW_RIWALENN ?></a>.
                            </p>
                            ...
                            <p>Le site <a href="<?= Constantes::HTTPS_URL.Constantes::WWW_RIWALENN ?>"><?= Constantes::WWW_RIWALENN ?></a> contient un
                                certain
                            ...
                            <p>La navigation sur le site <a href="<?= Constantes::HTTPS_URL.Constantes::WWW_RIWALENN ?>"><?= Constantes::WWW_RIWALENN ?></a>
                            ...
                            <p>Tout litige en relation avec l’utilisation du site <a
                                    href="<?= Constantes::HTTPS_URL.Constantes::WWW_RIWALENN ?>"><?= Constantes::WWW_RIWALENN ?></a>
