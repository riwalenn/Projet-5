...
<div class="conditions-modal modal fade" id="versionModal" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            ...
                            <p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans
                                l'économie numérique, il est précisé aux utilisateurs du site <a
                                        href="<?= htmlspecialchars(Constantes::HTTPS_URL.htmlspecialchars(Constantes::WWW_RIWALENN)) ?>"><?= htmlspecialchars(Constantes::WWW_RIWALENN) ?></a> l'identité des
                            ...
                            <p><strong>Propriétaire</strong> : Riwalenn Bas – 1 rue françois arago<br/>
                                <strong>Créateur</strong> : <a href="https://<?= htmlspecialchars(Constantes::WWW_RIWALENN) ?>">Riwalenn Bas</a><br/>
                                ...
                                <strong>Hébergeur</strong> : O2Switch.fr – 222-224 Boulevard Gustave Flaubert 63000
                                Clermont-Ferrand<br/>
                                Crédits : <br/>
                                Le modèle de mentions légales est offert par Subdelirium.com <a target="_blank"
                                                                                                href="https://www.subdelirium.com/generateur-de-mentions-legales/">Modèle
                                    de mentions légales</a><br>
                                Les images proviennent des sites <a href="https://pixabay.com/" target="_blank">Pixabay.com</a>
                                et <a href="https://www.pexels.com/" target="_blank">Pexel</a>.<br/>
                                Photos de Jessica Lewis, Jess Bailey Designs, Karolina Grabowska et Buenosia Carol provenants de Pexels
                            </p>

                            <h3>2. Conditions générales d’utilisation du site et des services proposés.</h3>
                            <p>L’utilisation du site <a href="<?= htmlspecialchars(Constantes::HTTPS_URL.htmlspecialchars(Constantes::WWW_RIWALENN)) ?>"><?= htmlspecialchars(Constantes::WWW_RIWALENN) ?></a>
                                ...
                                à tout moment, les utilisateurs du site <a href="<?= htmlspecialchars(Constantes::HTTPS_URL.htmlspecialchars(Constantes::WWW_RIWALENN)) ?>"><?= htmlspecialchars(Constantes::WWW_RIWALENN) ?></a>
                            ...
                            <p>Ce site est normalement accessible à tout moment aux utilisateurs. Une interruption pour
                                raison de maintenance technique peut être toutefois décidée par Riwalenn Bas, qui
                                s’efforcera alors de communiquer préalablement aux utilisateurs les dates et heures de
                                l’intervention.</p>
                            <p>Le site <a href="<?= htmlspecialchars(Constantes::HTTPS_URL.htmlspecialchars(Constantes::WWW_RIWALENN)) ?>"><?= htmlspecialchars(Constantes::WWW_RIWALENN) ?></a> est mis à jour
                                régulièrement par Riwalenn Bas. De la même façon, les mentions légales peuvent être
                                modifiées à tout moment : elles s’imposent néanmoins à l’utilisateur qui est invité à
                                s’y référer le plus souvent possible afin d’en prendre connaissance.</p>
                            <h3>3. Description des services fournis.</h3>
                            <p>Le site <a href="<?= htmlspecialchars(Constantes::HTTPS_URL.htmlspecialchars(Constantes::WWW_RIWALENN)) ?>"><?= htmlspecialchars(Constantes::WWW_RIWALENN) ?></a> a pour objet de
                                fournir une information concernant l’ensemble des activités de la société.</p>
                            <p>Riwalenn Bas s’efforce de fournir sur le site <a href="<?= htmlspecialchars(Constantes::HTTPS_URL.htmlspecialchars(Constantes::WWW_RIWALENN)) ?>"><?= htmlspecialchars(Constantes::WWW_RIWALENN) ?></a>
                                ...
                                informations.</p>
                            <p>Tous les informations indiquées sur le site <a href="<?= htmlspecialchars(Constantes::HTTPS_URL.htmlspecialchars(Constantes::WWW_RIWALENN)) ?>"><?= htmlspecialchars(Constantes::WWW_RIWALENN) ?></a>
                                sont données à titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
                                renseignements figurant sur le site <a href="<?= htmlspecialchars(Constantes::HTTPS_URL.htmlspecialchars(Constantes::WWW_RIWALENN)) ?>"><?= htmlspecialchars(Constantes::WWW_RIWALENN) ?></a>
                            ...
                            <p>Le site Internet ne pourra être tenu responsable de dommages matériels liés à
                            ...
                            <p>Riwalenn Bas est propriétaire des droits de propriété intellectuelle ou détient les
                            ...
                            <p>Toute reproduction, représentation, modification, publication, adaptation de tout ou
                                ...
                                interdite, sauf autorisation écrite préalable de : Riwalenn Bas.</p>
                            ...
                            <p>Riwalenn Bas ne pourra être tenue responsable des dommages directs et indirects causés au
                                matériel de l’utilisateur, lors de l’accès au site <?= htmlspecialchars(Constantes::WWW_RIWALENN) ?>, et résultant
                            ...
                            <p>Riwalenn Bas ne pourra également être tenue responsable des dommages indirects (tels par
                                exemple qu’une perte de marché ou perte d’une chance) consécutifs à l’utilisation du
                                site <a href="<?= htmlspecialchars(Constantes::HTTPS_URL.htmlspecialchars(Constantes::WWW_RIWALENN)) ?>"><?= htmlspecialchars(Constantes::WWW_RIWALENN) ?></a>.</p>
                            <p>Des espaces interactifs (possibilité de poser des questions dans l’espace contact) sont à
                                la disposition des utilisateurs. Riwalenn Bas se réserve le droit de supprimer, sans
                                ...
                                protection des données. Le cas échéant, Riwalenn Bas se réserve également la possibilité
                                de mettre en cause la responsabilité civile et/ou pénale de l’utilisateur, notamment en
                                cas de message à caractère raciste, injurieux, diffamant, ou pornographique, quel que
                            ...
                            <p>En France, les données personnelles sont notamment protégées par la loi n° 78-87 du 6
                                ...
                                Directive Européenne du 24 octobre 1995.</p>
                            <p>A l'occasion de l'utilisation du site <a href="<?= htmlspecialchars(Constantes::HTTPS_URL.htmlspecialchars(Constantes::WWW_RIWALENN)) ?>"><?= htmlspecialchars(Constantes::WWW_RIWALENN) ?></a>,
                                peuvent êtres recueillies : l'URL des liens par l'intermédiaire desquels l'utilisateur a
                                accédé au site <a href="<?= htmlspecialchars(Constantes::HTTPS_URL.htmlspecialchars(Constantes::WWW_RIWALENN)) ?>"><?= htmlspecialchars(Constantes::WWW_RIWALENN) ?></a>, le
                            ...
                            <p> En tout état de cause Riwalenn Bas ne collecte des informations personnelles relatives à
                                l'utilisateur que pour le besoin de certains services proposés par le site <a
                                        href="<?= htmlspecialchars(Constantes::HTTPS_URL.htmlspecialchars(Constantes::WWW_RIWALENN)) ?>"><?= htmlspecialchars(Constantes::WWW_RIWALENN) ?></a>. L'utilisateur
                                ...
                                lui-même à leur saisie. Il est alors précisé à l'utilisateur du site <a
                                        href="<?= htmlspecialchars(Constantes::HTTPS_URL.htmlspecialchars(Constantes::WWW_RIWALENN)) ?>"><?= htmlspecialchars(Constantes::WWW_RIWALENN) ?></a> l’obligation ou non
                            ...
                            <p>Aucune information personnelle de l'utilisateur du site <a
                                    href="<?= htmlspecialchars(Constantes::HTTPS_URL.htmlspecialchars(Constantes::WWW_RIWALENN)) ?>"><?= htmlspecialchars(Constantes::WWW_RIWALENN) ?></a> n'est publiée à l'insu
                                de
                                ...
                                l'utilisateur du site <a href="<?= htmlspecialchars(Constantes::HTTPS_URL.htmlspecialchars(Constantes::WWW_RIWALENN)) ?>"><?= htmlspecialchars(Constantes::WWW_RIWALENN) ?></a>.
                            </p>
                            ...
                            <p>Le site <a href="<?= htmlspecialchars(Constantes::HTTPS_URL.htmlspecialchars(Constantes::WWW_RIWALENN)) ?>"><?= htmlspecialchars(Constantes::WWW_RIWALENN) ?></a> contient un
                                certain
                            ...
                            <p>La navigation sur le site <a href="<?= htmlspecialchars(Constantes::HTTPS_URL.htmlspecialchars(Constantes::WWW_RIWALENN)) ?>"><?= htmlspecialchars(Constantes::WWW_RIWALENN) ?></a>
                            ...
                            <p>Tout litige en relation avec l’utilisation du site <a
                                    href="<?= htmlspecialchars(Constantes::HTTPS_URL.htmlspecialchars(Constantes::WWW_RIWALENN)) ?>"><?= htmlspecialchars(Constantes::WWW_RIWALENN) ?></a>
