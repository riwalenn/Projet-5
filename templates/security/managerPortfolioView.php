                                ...
                                <form action="index.php?action=portfolio-manager&CRUD=SU" method="post">
                                    ...
                                    <tr>
                                        <td><a data-toggle="modal"
                                               href="#formModalEdit<?= $folio->getId() ?>"><?= View::generatePortfolioPicture($folio, Constantes::SMALLIMG) ?></a>
                                        </td>
                                        ...
                                        <td><input type="number" name="date_conception"
                                                   ...
                                                   min="2009" max="2022"></td>
                                        <td><input type="text" name="client" value="<?= $folio->getClient() ?>"></td>
                                        <td><textarea name="categories"
                                                      rows="2"><?= $folio->getCategories() ?></textarea></td>
                                        <td>
...
<!-- Modal modif folio -->
<?php foreach ($portfolio as $folio) : ?>
    <div class="articles-modal modal fade" id="formModalEdit<?= $folio->getId() ?>" tabindex="-1" role="dialog"
         aria-hidden="true">
                                ...
                                <form method="post" action="index.php?action=portfolio-manager&CRUD=U"
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input class="form-control form-control-sm" type="text" id="title" name="title"
                                               value="<?= $folio->getTitle() ?>" placeholder="Inscrivez le titre ici">
                                    </div>
                                    <div class="input-group mb-3">
                                        <label for="kicker"></label>
                                        <input class="form-control form-control-sm" type="text" id="kicker"
                                               name="kicker" value="<?= $folio->getKicker() ?>"
                                               placeholder="Inscrivez le châpo ici">
                                    </div>
                                    <div class="input-group mb-3">
                                        <label for="content"></label>
                                        <textarea class="form-control form-control-sm" id="content"
                                                  placeholder="Inscrivez le contenu ici" name="content"
                                                  rows="5"><?= $folio->getContent() ?></textarea>
                                    </div>
                                    <div class="input-group mb-3">
                                        <label for="date_conception"></label>
                                        <input class="form-control form-control-sm" type="text" id="date_conception"
                                               name="date_conception" value="<?= $folio->getDate_conception() ?>"
                                               placeholder="YYYY" min="2009" max="2022">
                                    </div>
                                    <div class="input-group mb-3">
                                        <label for="client"></label>
                                        <input class="form-control form-control-sm" type="text" id="client"
                                               name="client" value="<?= $folio->getClient() ?>"
                                               placeholder="Inscrivez le client ici">
                                    </div>
                                    <div class="input-group mb-3">
                                        <label for="categories"></label>
                                        <input class="form-control form-control-sm" type="text" id="categories"
                                               name="categories" value="<?= $folio->getCategories() ?>"
                                               placeholder="Inscrivez les catégories ici">
                                    </div>
                    ...
                    <div class="col-lg-8 mx-auto">
                        <div class="modal-body">
                            ...
                            <form method="post" action="index.php?action=portfolio-manager&CRUD=C"
                                ...
                                <div class="input-group mb-3">
                                    <label for="kicker"></label>
                                    <input class="form-control form-control-sm" type="text" id="kicker" name="kicker"
                                           placeholder="Inscrivez le châpo ici">
                                </div>
                                <div class="input-group mb-3">
                                    <label for="content"></label>
                                    <textarea class="form-control form-control-sm" id="content"
                                              placeholder="Inscrivez le contenu ici" name="content" rows="5"></textarea>
                                </div>
                                <div class="input-group mb-3">
                                    <label for="date_conception"></label>
                                    <input class="form-control form-control-sm" type="text" id="date_conception"
                                           name="date_conception" placeholder="YYYY" min="2009" max="2022">
                                </div>
                                <div class="input-group mb-3">
                                    <label for="client"></label>
                                    <input class="form-control form-control-sm" type="text" id="client" name="client"
                                           placeholder="Inscrivez le client ici">
                                </div>
                                <div class="input-group mb-3">
                                    <label for="categories"></label>
