            ...
            <div class='ui fluid hidden helpmessage'>
                ...
                <div class='popover-body'>
                    <p>Cliquez sur les <i class="fas fa-info-circle pseudo"></i> du formulaire pour avoir plus
                        d'informations.</p>
                    <p class='pseudo-popup'><?= $messagePseudo ?></p>
                    ...
                    <div class="col-lg-8 mx-auto">
                        <div class="modal-body">
                            ...
                            <p><strong>Propriétaire</strong> : Riwalenn Bas – 1 rue françois arago<br/>
                                <strong>Créateur</strong> : <a href="<?= Constantes::HTTPS_URL.Constantes::WWW_RIWALENN ?>">Riwalenn Bas</a><br/>
                            ...
                            <p>Aucune information personnelle de l'utilisateur du site <a
                                        href="<?= Constantes::HTTPS_URL.Constantes::WWW_RIWALENN ?>"><?= Constantes::WWW_RIWALENN ?></a> n'est publiée à
                                l'insu de
