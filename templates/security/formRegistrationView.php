                    ...
                    <div class="col-lg-8 mx-auto">
                        <div class="modal-body">
                            ...
                            <p><strong>Propriétaire</strong> : Riwalenn Bas – 1 rue françois arago<br/>
                                <strong>Créateur</strong> : <a href="<?= htmlspecialchars(Constantes::HTTPS_URL.htmlspecialchars(Constantes::WWW_RIWALENN)) ?>">Riwalenn Bas</a><br/>
                            ...
                            <p>Aucune information personnelle de l'utilisateur du site <a
                                        href="<?= htmlspecialchars(Constantes::HTTPS_URL.htmlspecialchars(Constantes::WWW_RIWALENN)) ?>"><?= htmlspecialchars(Constantes::WWW_RIWALENN) ?></a> n'est publiée à
                                l'insu de
